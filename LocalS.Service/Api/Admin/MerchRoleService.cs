...
{
    public class MerchRoleService : BaseDbContext
    {
        public CustomJsonResult GetList(string operater, RupMerchRoleGetList rup)
        {
        ...
        public CustomJsonResult Add(string operater, RopMerchRoleAdd rop)
        {
            var result = new CustomJsonResult();
        ...
        public CustomJsonResult InitEdit(string operater, string roleId)
        {
            ...
            var ret = new RetMerchRoleInitEdit();
        ...
        public CustomJsonResult Edit(string operater, RopMerchRoleEdit rop)
        {
